...
const HINTS: Hint[] = [
  {
    ...
    touchText: '🔄 Flipped — tap ⟲ to recover (−5 s).',
  ...
  },
  {
    ...
    touchText: '🧲 Spilled — get close, tap 🧲.',
  ...
  },
  {
    ...
    touchText: '🚧 Barriers — aim for the gap.',
  ...
  },
  {
    ...
    touchText: '💧 Water — you’ll hydroplane.',
    test: (c) => c.inPuddle,
  },
  {
    id: 'train',
    ...
    touchText: '🚂 Crossing — stop if the gate drops.',
  ...
  },
  {
    ...
    touchText: '⚠ Rockfall — avoid the amber rings.',
  ...
  },
  {
    ...
    touchText: '💥 Blasting — keep right, hang back.',
  ...
  },
  {
    ...
    touchText: '⚠ Crane — time the swing.',
  ...
  },
  {
    ...
    touchText: '🚚 Oncoming haulers — hold a clear lane.',
